        ...
        if (this.options.vertical) {
            ...
            var self = this,
                ...
                valuebg = this.options.highlight && !isToggleSwitch ? (function() {
					...
					return $( bg ).css({ "width": "100%", "position": "absolute", "bottom": "0px" }).prependTo( slider );
                })() : false,
                options,
                wrapper,
                j, length,
            ...
            this.slider.attr("style", "width:20px !important; margin: 0 0 20px 14px; height:"+this.options.height+"px;")
            $(this.control).detach()
...
// invert min and max
            ...
            if ( this.valuebg ) {
                this.valuebg.css( "height", (100 - Number(percent)) + "%" );
            }
